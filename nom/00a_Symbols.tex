...
\addsymbol{dwb}{\ensuremath{d_{wb}}}{Wheelbase (mm)}
...
\addsymbol{cgx}{$CG_x$}{Longitudinal centre of gravity (mm)}
\addsymbol{cgy}{$CG_y$}{Lateral centre of gravity (mm)}
\addsymbol{cgz}{$CG_z$}{Vertical centre of gravity (mm)}

\addsymbol{ixx}{$I_{xx}$}{Roll moment of inertia (kg$\cdot$m\textsuperscript{2})}
\addsymbol{iyy}{$I_{yy}$}{Pitch moment of inertia (kg$\cdot$m\textsuperscript{2})}
\addsymbol{izz}{$I_{zz}$}{Yaw moment of inertia (kg$\cdot$m\textsuperscript{2})}

\addsymbol{rx}{$r_x$}{Roll radius of gyration (m)}
\addsymbol{ry}{$r_y$}{Pitch radius of gyration (m)}
\addsymbol{rz}{$r_z$}{Yaw radius of gyration (m)}

\addsymbol{cv}{$CV$}{Coefficient of variation (\%)}